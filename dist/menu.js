 ...
 */
function displayItems(items, selectedIndex, selectedItems) {
 ...
 */
export async function interactiveMenu(root) {
 ...
 */
export function buildCategoryMenuTree(categories, location) {
    const root = {
        id: 'root',
        label: 'Root',
        type: 'folder',
    ...
    if (categories['general']) {
        generalChildren.push({
            ...
            type: 'folder',
            children: (categories['general'].agents || []).map((a) => ({
                id: `agent:${a.name}`,
                label: a.displayName,
                type: 'file',
            })),
        ...
        generalChildren.push({
            ...
            type: 'folder',
            children: (categories['general'].commands || []).map((c) => ({
                id: `command:${c.name}`,
                label: c.displayName,
                type: 'file',
            })),
        ...
        generalChildren.push({
            ...
            type: 'folder',
            children: (categories['general'].skills || []).map((s) => ({
                id: `skill:${s.name}`,
                label: s.displayName,
                type: 'file',
            })),
        ...
        if (categories['frontend']) {
            if ((categories['frontend'].agents || []).length > 0) {
                frontendChildren.push({
                    ...
                    type: 'folder',
                    children: (categories['frontend'].agents || []).map((a) => ({
                        id: `agent:${a.name}`,
                        label: a.displayName,
                        type: 'file',
                    })),
            ...
            if ((categories['frontend'].commands || []).length > 0) {
                frontendChildren.push({
                    ...
                    type: 'folder',
                    children: (categories['frontend'].commands || []).map((c) => ({
                        id: `command:${c.name}`,
                        label: c.displayName,
                        type: 'file',
                    })),
            ...
            if ((categories['frontend'].skills || []).length > 0) {
                frontendChildren.push({
                    ...
                    type: 'folder',
                    children: (categories['frontend'].skills || []).map((s) => ({
                        id: `skill:${s.name}`,
                        label: s.displayName,
                        type: 'file',
                    })),
        ...
        if (categories['backend']) {
            if ((categories['backend'].agents || []).length > 0) {
                backendChildren.push({
                    ...
                    type: 'folder',
                    children: (categories['backend'].agents || []).map((a) => ({
                        id: `agent:${a.name}`,
                        label: a.displayName,
                        type: 'file',
                    })),
            ...
            if ((categories['backend'].commands || []).length > 0) {
                backendChildren.push({
                    ...
                    type: 'folder',
                    children: (categories['backend'].commands || []).map((c) => ({
                        id: `command:${c.name}`,
                        label: c.displayName,
                        type: 'file',
                    })),
            ...
            if ((categories['backend'].skills || []).length > 0) {
                backendChildren.push({
                    ...
                    type: 'folder',
                    children: (categories['backend'].skills || []).map((s) => ({
                        id: `skill:${s.name}`,
                        label: s.displayName,
                        type: 'file',
                    })),
