...
import { interactiveMenu, buildCategoryMenuTree } from './menu.js';
...
async function main() {
    ...
    // Build menu tree
    const menuRoot = buildCategoryMenuTree(groupedComponents, location);
    ...
    console.log(chalk.cyan(`  Total: ${selections.agents.length} agents, ${selections.commands.length} commands, ${selections.skills.length} skills\n`));
